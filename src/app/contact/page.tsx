          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                <a
                  href="mailto:hello@matthallwastaken.dev?subject=Project Inquiry&body=Hi Matt,%0D%0A%0D%0AI'd like to discuss a project with you.%0D%0A%0D%0AProject details:%0D%0A- %0D%0A- %0D%0A- %0D%0A%0D%0ATimeline:%0D%0ABudget:%0D%0A%0D%0AThanks!"
                ...
                <a
                  href="mailto:hello@matthallwastaken.dev?subject=Collaboration Opportunity&body=Hi Matt,%0D%0A%0D%0AI'd like to explore a collaboration opportunity with you.%0D%0A%0D%0ADetails:%0D%0A%0D%0ABest regards,"
                ...
                <a
                  href="mailto:hello@matthallwastaken.dev?subject=Just Saying Hi&body=Hi Matt,%0D%0A%0D%0AJust wanted to reach out and say hi!%0D%0A%0D%0A"
                  className="block w-full border border-foreground px-6 py-4 rounded-lg text-center font-medium hover:bg-foreground hover:text-background transition-colors"
                >
                  Just Say Hi 👋
                </a>
