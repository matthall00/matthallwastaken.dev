  ...
  return (
    <Section>
      <Container>
        ...
        <p className="mt-4 text-white/80">Email works: <a className="underline hover:text-white" href="mailto:contact@slightlyprivate.com">contact@slightlyprivate.com</a>.</p>
